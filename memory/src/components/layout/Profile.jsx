    ...
    <div className="flex justify-center mt-60 bg-white">
      <div className="flex-column">
        ...
        <div className="flex mt-4">
          <button className="w-2 h-2 rounded-3xl bg-green-500"></button>
          <p>Available new projects</p>
        </div>
      ...
      <div className="ml-20">
        <img
          className="h-60 w-50"
          src="https://s3-alpha-sig.figma.com/img/f85c/f455/11cd2ba02a83d564218d6500a134a91d?Expires=1707091200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=a6tWb8bSslEMvoWpbAKxHFRgwRthzMR7eG1Kfve0P0Ap3a7XJ~Dq9wzWQPJRwNlUzxhq0tXthBeCL0BtLqdX1jpkXAnSbAd-BjW1OCcoIMPPUfT2DWvKVh8Z7NRrIJVO~eel6RwQW1crWSY6ErFzxqS~n2KcWS9ibsqq-o8BQKOEl2Aw23aDTCULdVDdcjwLwobrFTH6TcDqPI7lDQbglLR5lcHivDEMpQ1-XRxYhAIvdi-9YcIL0NEV0pLE7e1JPM-cPpyOm5oXkH31GXZIz5WY356eJj8HCAWkEAg3ch0hEgE6raptZVGeiK1lfGR4sOd3eUFgRrcWNWGzJAyEEg__"
          alt=""
        />
      </div>
    </div>
